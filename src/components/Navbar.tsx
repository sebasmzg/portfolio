...
const Navbar = () => {
    ...
    return (
        <div className='text-white/70 pt-6'>
                    ...
                    <li>
                        <a href='#contact' className='group'>
                            ...
                            <div className='relative'>
                                <div className='absolute w-2/3 h-1 transition-all duration-300 ease-out bg-green-600 rounded-full group-hover:w-full'></div>

                                <div className='mt-1 absolute w-1/3 h-1 transition-all duration-300 ease-out bg-green-800 rounded-full group-hover:w-full'></div>
            ...
            >
                <ul className='taxt-4xl font-semibold my-24 text-center space-y-8'>
                    {navLinks.map((link,index)=>(
                        <li key={index}>
